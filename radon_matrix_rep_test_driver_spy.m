...
clf;
spy(M);
title('Non-zero coefficients in the matrix representation of $\mathcal R$');

% Step 3: Plot the sparsity pattern of the matrix representation
figure(2);
spy(M);
title('Sparsity Pattern of the Matrix Representation of Radon Transform');
